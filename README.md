...
- **System tray support** - Access from the system tray.
- **Custom database location** - Store your database anywhere, including external or network drives, to keep your data accessible across multiple systems.
