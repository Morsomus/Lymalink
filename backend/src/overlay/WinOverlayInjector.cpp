...
bool WinOverlayInjector::InjectDirect3D11(uint32_t pid) const
{
    return InjectOverlayLibrary(pid, L"lymalink-overlay-dx11-x86.dll", L"lymalink-overlay-dx11-x64.dll", "Direct3D11");
}

/////////////////////////////////////////////////////////////////////

bool WinOverlayInjector::InjectDirect3D12(uint32_t pid) const
{
    return InjectOverlayLibrary(pid, L"lymalink-overlay-dx12-x86.dll", L"lymalink-overlay-dx12-x64.dll", "Direct3D12");
}
