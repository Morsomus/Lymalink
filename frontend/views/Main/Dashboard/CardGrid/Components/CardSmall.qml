...
Rectangle {
    ...
    Rectangle {
        ...
        color: Themes.cardSmall.colors.cover
        ...
        Image {
            ...
            Rectangle {
                anchors.fill: parent
                color: Themes.cardSmall.colors.loadingOverlay
                opacity: 0.55
    ...
    Rectangle {
        ...
        radius: id_root.radius
        color: Themes.cardSmall.colors.rootHoverOverlay
        ...
        Rectangle {
            ...
            gradient: Gradient {
                GradientStop {
                    position: 0.0
                    color: Themes.cardSmall.colors.rootHoverGradientStart
                }

                GradientStop {
                    position: 1.0
                    color: Themes.cardSmall.colors.rootHoverGradientEnd
                }
            }
        }
    ...
    Item {
        ...
        Rectangle {
            ...
            width: id_achievementsBadge.width + 21
            gradient: Gradient {
                orientation: Gradient.Horizontal

                GradientStop {
                    position: 0.0
                    color: Themes.cardSmall.colors.achievementsBadgeGradientStart
                }

                GradientStop {
                    position: 1.0
                    color: Themes.cardSmall.colors.achievementsBadgeGradientEnd
                }
            }
    ...
    Item {
        ...
        Rectangle {
            ...
            height: 52
            radius: width / 2
            color: Themes.cardSmall.colors.installationStatusBadgeBackground
        ...
        Image {
            anchors {
                ...
                topMargin: id_installStatusBadgeBackground.width / 2
                leftMargin: id_installStatusBadgeBackground.height / 2
            }
            width: 18
            height: 18
    ...
    layer.effect: MultiEffect {
        shadowEnabled: true
        shadowColor: Themes.cardSmall.colors.rootDropshadow
        shadowOpacity: id_rootMouseArea.containsMouse ? Themes.cardSmall.opacity.shadowHover : Themes.cardSmall.opacity.shadowIdle
        shadowBlur: 1.0
