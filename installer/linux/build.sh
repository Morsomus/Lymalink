...
cp "$ROOT_DIR/backend/res/img/BlankBackground_MFC_00041_ED_ERR.png" "$RELEASE_DIR/share/Lymalink/lymalinkd-tray-icon-error.png"
cp "$ROOT_DIR/frontend/res/img/BlankBackground_MFC_00002_E_256x256.png" "$RELEASE_DIR/share/icons/hicolor/256x256/apps/lymalink.png"
